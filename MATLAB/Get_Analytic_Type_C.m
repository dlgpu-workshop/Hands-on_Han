function [z_analytic,phi_analytic]=Get_Analytic_Type_C(Zmin,Zmax,angle)
...
solinit=bvpinit(linspace(Zmin*lambda,Zmax*lambda,200),[1.0,-0.01]);
sol=bvp4c(@(t,y)odefcn(t,y,p),@(ya,yb)bcfcn(ya,yb,p),solinit);
%% ODE solved
x=linspace(Zmin*lambda,Zmax*lambda,200);
